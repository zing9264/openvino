...
cam_LIO = GradCAM(model=model_LIO, target_layers=target_layer_LIO, use_cuda=True)
cam_NORM = GradCAM(model=model_NORM, target_layers=target_layer_NORM, use_cuda=True)
