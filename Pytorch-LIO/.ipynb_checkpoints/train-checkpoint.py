...
if MODEL_NAME == 'mobilenet':
    model = mobilenet(in_dim=960, num_classes=NUM_CLASSES, size=round(7/448 * RESOLUTION), with_LIO=WITH_LIO)
else:
    model = resnet(stage=STAGE, in_dim=2048, num_classes=NUM_CLASSES, size=round(7/448 * RESOLUTION), with_LIO=WITH_LIO)
